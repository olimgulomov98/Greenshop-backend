...
import { Member } from 'apps/greenshop-api/src/libs/dto/member/member';
import { Property } from 'apps/greenshop-api/src/libs/dto/property/property';
import {
  MemberStatus,
  MemberType,
} from 'apps/greenshop-api/src/libs/enums/member.enum';
import { PropertyStatus } from 'apps/greenshop-api/src/libs/enums/property.enum';
